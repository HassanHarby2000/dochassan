var cookieconsent = function (e) {
    ...
    function m(e, n) {
        for (var o = [], t = {}, i = 0; i < e.length; i++) {
            var a = e[i], r = n.base ? a[0] + n.base : a[0], s = {css: a[1], media: a[2], sourceMap: a[3]};
            t[r] ? t[r].parts.push(s) : o.push(t[r] = {id: r, parts: [s]})
        }
        return o
    }
    ...
    function k(e, n) {
        ...
        var t = p[p.length - 1];
        if ("top" === e.insertAt) t ? t.nextSibling ? o.insertBefore(n, t.nextSibling) : o.appendChild(n) : o.insertBefore(n, o.firstChild), p.push(n); else if ("bottom" === e.insertAt) o.appendChild(n); else {
    ...
    function h(e, n) {
        ...
        if (n.singleton) {
            ...
            var t = o.css, i = o.sourceMap, a = void 0 === n.convertToAbsoluteUrls && i;
            (n.convertToAbsoluteUrls || a) && (t = d(t));
            i && (t += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(i)))) + " */");
            var r = new Blob([t], {type: "text/css"}), s = e.href;
    ...
    var t = function () {
        ...
        }(), i = o(2), a = o(3), r = o(4), s = o(5), c = o(6), l = o(7), p = o(8), d = o(9), u = o(10), m = o(11),
        k = o(12), f = o(13), g = o(14), v = o(15), h = o(16), _ = function () {
            function e(e) {
            ...
            return e.prototype.detectUserLanguage = function () {
                ...
                this.availableLanguages = [{value: "en", title: "English"}, {value: "de", title: "German"}, {
                    ...
                    value: "pt",
                    title: "Portugese"
                }, {value: "hu", title: "Hungarian"}, {value: "hr", title: "Croatian"}, {
                    value: "da",
                    title: "Danish"
                }, {value: "ro", title: "Romanian"}, {value: "sl", title: "Slovenian"}, {
                    value: "pl",
                    title: "Polish"
                }, {value: "sr", title: "Serbian"}, {value: "el", title: "Greek"}, {
                    value: "cy",
                    title: "Welsh"
    ...
    var b, y, w = (b = function (e, n) {
        return (b = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (e, n) {
            e.__proto__ = n
        } || function (e, n) {
        ...
        return e.prototype.checkIfUserAccepted = function () {
            ...
            if (null === n) document.dispatchEvent(this.cookieConsent.events.cc_freshUser), this.enableAllCookies(); else {
        ...
        return e.prototype.listenToUserButtonToOpenPreferences = function (e) {
            ...
            if ("strictly-necessary" !== e.id) {
                var i = n.cookieConsent.userConsent.acceptedLevels, a = document.createElement("input");
                a.setAttribute("cookie_consent_toggler", "true"), a.setAttribute("type", "checkbox"), a.setAttribute("class", "checkbox_cookie_consent"), a.setAttribute("id", e.id), a.setAttribute("name", e.id), (r = document.createElement("label")).setAttribute("for", e.id), i[e.id] ? (a.setAttribute("checked", "checked"), r.setAttribute("class", "is-active"), r.innerHTML = n.cookieConsent.i18n.$t("dialog", "active")) : (r.setAttribute("class", "is-inactive"), r.innerHTML = n.cookieConsent.i18n.$t("dialog", "inactive")), a.addEventListener("change", function () {
                    var o = a.checked, t = e.id, i = document.querySelector('label[for="' + t + '"]');
        ...
        return e.prototype.initDialog = function () {
            ...
            var i = document.createElement("div"), a = document.createElement("p");
